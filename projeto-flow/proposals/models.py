...
class Proposal(Base):
    ...
    research = models.ForeignKey('pesquisador.Researcher', on_delete=models.CASCADE, related_name='researcher_proposals')
...
class RectifyProposal(Base):
    research = models.ForeignKey('pesquisador.Researcher', on_delete=models.CASCADE, related_name='rectify_researcher_proposals')
