from .views import ProposalListVew, pesquisador_projetos, pesquisador_projetos_detalhes, base, pesquisador_adicionar_projeto, pesquisador_editar_projeto
from . import views
...
urlpatterns = [
    ...
    path('', ProposalListVew.as_view(), name='pesquisador-editais'),
