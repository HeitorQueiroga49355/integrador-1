from .views import PesquisadorEditaisView, ProjectListView, ProjectCreateView, pesquisador_projetos, pesquisador_projetos_detalhes, base, pesquisador_adicionar_projeto, pesquisador_editar_projeto
from . import views
...
urlpatterns = [
    ...
    path('projetos/adicionar/', views.ProjectCreateView.as_view(), name='pesquisador-adicionar-projeto'),
