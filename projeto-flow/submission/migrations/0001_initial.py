    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_file', models.FileField(blank=True, help_text='Faça upload do arquivo PDF principal da submissão', null=True, upload_to='submissions/', verbose_name='Arquivo Principal da Submissão')),
                ('attachments', models.FileField(blank=True, help_text='Anexos complementares à submissão', null=True, upload_to='submissions/attachments', verbose_name='Anexos (opcional)')),
